package mg.groupe26.enchere.model.psql;
...
public class Enchere {
    ...
    public void insert(JdbcTemplate jt) {
        String query = String.format("insert into Enchere values (concat('Enchere',nextval('seq_enchere')), '%s', default, %s, default, default, default, '%s', '%s', %s, '%s')", getProprietaireId(), getDuree(), getNomProduit(), getDescri(), getPrixMin(), getCategorieId());
        jt.update(query);
    }
